...
public class FancyCoverFlow extends Gallery {
    ...
    public String TAG = "FancyCoverFlow";
    ...
    private void applyXmlAttributes(AttributeSet attrs) {
        ...
        this.unselectedAlpha = a.getFloat(R.styleable.FancyCoverFlow_unselectedAlpha, 0.0f);
...
//        LogUtils.i(TAG,"childCount: "+ childCount + " i: "+ i + " super: "+ super.getChildDrawingOrder(childCount, i));
