 ...
 *
 */
public class CollectionPageDrawBridge extends OpenEffectBridge {
	public static final String TAG = "CollectionPageDrawBridge";
		...
		mAnimatorSet.addListener(new AnimatorListener() {
			...
			public void onAnimationStart(Animator animation) {
				...
				if (getNewAnimatorListener() != null)
					getNewAnimatorListener().onAnimationStart(CollectionPageDrawBridge.this, focusView, animation);
			}
			...
			public void onAnimationEnd(Animator animation) {
				...
				if (getNewAnimatorListener() != null)
					getNewAnimatorListener().onAnimationEnd(CollectionPageDrawBridge.this, focusView, animation);
