...
public abstract class ProgressHintDelegate implements OnSeekBarChangeListener {
    ...
    private java.lang.String TAG = "ProgressHintDelegate";
    ...
    public ProgressHintDelegate(SeekBar seekBar, AttributeSet attrs, int defStyleAttr) {
        ...
        //
        int mPopupLayout =
                a.getResourceId(R.styleable.ProgressHint_popupLayout, R.layout.layout_seekbar_popwindow);
...
//        }
        ...
        mPopupTextView = (TextView) mPopupView.findViewById(R.id.tvPop);
        int progress = mSeekBar.getProgress();
        String init_time = mSeekBar.getContext().getApplicationContext().getResources().getString(R.string.pop_time_init);
        mPopupTextView.setText(popupText != null ? popupText : progress == 0 ? init_time :
                android.text.format.DateUtils.formatElapsedTime(progress));
        // init popup
    ...
    public Runnable mShowPop = new Runnable() {
        @Override
        public void run() {
            LogUtils.i(TAG, "+showPopup()");
            showPopupInternally();
        }
    };

    public void showPopup() {
        handler.post(mShowPop);
    }
    ...
    public void hidePopup() {
        handler.removeCallbacks(mShowPop);
    ...
    public void setPopupAlwaysShown(boolean alwaysShown) {
        ...
        LogUtils.i(TAG, "setPopupAlwaysShown");
        showPopup();
    }
    ...
    public void setPopupText(String str) {
        ...
        mPopupTextView.setText(popupText != null ? popupText : String.valueOf(str));
    ...
    public void onDetachedFromWindow() {
        ...
        hidePopup();
//        handler.removeCallbacksAndMessages(mShowPop);
    }
    ...
    protected int getFollowPosition(int progress) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.JELLY_BEAN) {
            rect = mSeekBar.getThumb().copyBounds();
        }
        int followPosition = rect.centerX() + mSeekBar.getPaddingLeft();
        LogUtils.i(TAG, "followPosition =" + followPosition);
