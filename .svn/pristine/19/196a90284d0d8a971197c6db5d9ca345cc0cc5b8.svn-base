...
public class SoftKeyboardView extends View {
    ...
    protected void onDraw(Canvas rootCanvas) {
        ...
        if (mCacheBitmap == null) {
            LogUtils.e("onDraw mCacheBitmap:" + mCacheBitmap);
...
//			canvas.drawRect(rect, paint);
    ...
    public boolean moveToNextKey(int direction) {
        if (mSoftKeyboard == null) {
            LogUtils.e("moveToNextKey mSoftKeyboard is null");
            return false;
        }
        ...
        if (keyRow == null) {
            LogUtils.e("moveToNextKey keyRow is null");
            return false;
        }

        List<SoftKey> softKeys = keyRow.getSoftKeys();
        if (softKeys == null) {
            LogUtils.e("moveToNextKey keyRow -> softKeys is null");
            return false;
        }
